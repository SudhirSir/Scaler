...
| **SYNTHETIC_REPLACEMENTS** | **933** | Expected format-preserving synthetic replacements (Faker / cache). |
| **NEW_OR_UNMATCHED_PII_LIKE** | **979** | PII-shaped spans not in original inventory and not in replacement cache. |
